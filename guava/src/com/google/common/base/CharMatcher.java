...
public abstract class CharMatcher implements Predicate<Character> {
    ...
    public static CharMatcher anyOf(final CharSequence sequence) {
        switch (sequence.length()) {
            ...
            default:
                // TODO(lowasser): is it potentially worth just going ahead and building a
                // precomputed
                // matcher?
    ...
    CharMatcher precomputedInternal() {
        ...
        if (totalCharacters * 2 <= DISTINCT_CHARS) {
            ...
            String negatedDescription = description.endsWith(suffix)
                            ? description.substring(0, description.length() - suffix.length()) : description + suffix;
    ...
    private String finishCollapseFrom(CharSequence sequence, int start, int end, char replacement, StringBuilder builder,

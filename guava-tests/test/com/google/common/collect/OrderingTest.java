...
public class OrderingTest extends TestCase {
    ...
    public void testComplicatedOrderingExample() {
        ...
        Ordering<Iterable<Integer>> example = Ordering.<Integer> natural().nullsFirst().reverse().lexicographical().reverse()
                        .nullsLast();
        ...
        assertThat(sorted).containsExactly(Lists.newArrayList(nullInt, nullInt), Lists.newArrayList(nullInt),
                                           Lists.newArrayList(1, null, 2), Lists.newArrayList(1, 1), Lists.newArrayList(1, 2),
                                           Lists.newArrayList(1), Lists.newArrayList(2), Lists.newArrayList(), null)
                        .inOrder();
    }
    ...
    public void testFrom() {
        ...
        new EqualsTester().addEqualityGroup(caseInsensitiveOrdering, Ordering.from(String.CASE_INSENSITIVE_ORDER))
    ...
    public void testExplicit_two() {
        ...
        new EqualsTester().addEqualityGroup(c, Ordering.explicit(42, 5)).addEqualityGroup(Ordering.explicit(5, 42))
                        .addEqualityGroup(Ordering.explicit(42)).testEquals();
        reserializeAndAssert(c);
    }
    ...
    public void testCompound_static() {
        Comparator<String> comparator = Ordering.compound(ImmutableList.of(byCharAt(0), byCharAt(1), byCharAt(2), byCharAt(3),
                                                                           byCharAt(4), byCharAt(5)));
        Helpers.testComparator(comparator, ImmutableList.of("applesauce", "apricot", "artichoke", "banality", "banana",
                                                            "banquet", "tangelo", "tangerine"));
    ...
    public void testCompound_instance() {
        ...
        Helpers.testComparator(comparator, ImmutableList.of("red", "yellow", "violet", "blue", "indigo", "green", "orange"));
    }
    ...
    public void testReverse() {
        ...
        new EqualsTester().addEqualityGroup(reverseOrder, numberOrdering.reverse())
                        .addEqualityGroup(Ordering.natural().reverse()).addEqualityGroup(Collections.reverseOrder())
                        .testEquals();
    }
    ...
    public void testOnResultOf_natural() {
        ...
        new EqualsTester().addEqualityGroup(comparator, Ordering.natural().onResultOf(StringLengthFunction.StringLength))
    ...
    public void testOnResultOf_chained() {
        ...
        new EqualsTester().addEqualityGroup(comparator, DECREASING_INTEGER.onResultOf(StringLengthFunction.StringLength))
    ...
    public void testLexicographical() {
        ...
        new EqualsTester().addEqualityGroup(lexy, ordering.lexicographical()).addEqualityGroup(numberOrdering.lexicographical())
                        .addEqualityGroup(Ordering.natural()).testEquals();
    }
    ...
    public void testNullsFirst() {
        ...
        new EqualsTester().addEqualityGroup(ordering, Ordering.natural().nullsFirst())
                        .addEqualityGroup(numberOrdering.nullsFirst()).addEqualityGroup(Ordering.natural()).testEquals();
    }
    ...
    public void testNullsLast() {
        ...
        new EqualsTester().addEqualityGroup(ordering, Ordering.natural().nullsLast())
                        .addEqualityGroup(numberOrdering.nullsLast()).addEqualityGroup(Ordering.natural()).testEquals();
    }
    ...
    public void testLeastOfIteratorLargeK() {
        List<Integer> list = Arrays.asList(4, 2, 3, 5, 1);
        assertEquals(Arrays.asList(1, 2, 3, 4, 5), Ordering.natural().leastOf(list.iterator(), Integer.MAX_VALUE));
    }
    ...
    private enum OrderingMutation {
        ...
        COMPOUND_THIS_WITH_NATURAL {
            ...
            <T> Scenario<?> mutate(Scenario<T> scenario) {
                ...
                Ordering<Composite<T>> ordering = scenario.ordering.onResultOf(Composite.<T> getValueFunction())
        ...
        COMPOUND_NATURAL_WITH_THIS {
            ...
            <T> Scenario<?> mutate(Scenario<T> scenario) {
                ...
                Ordering<Composite<T>> ordering = Ordering.natural()

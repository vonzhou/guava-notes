...
public class SimpleTimeLimiterTest extends TestCase {
    ...
    /**
     * 如果执行不够,则 future.get 会抛出 TimeoutException
     */
    ...
    /**
     * 如果callable抛出的异常属于 RuntimeException, 则抛出 UncheckedExecutionException,
     * 否则 ExecutionException
     */
    ...
    /**
     * 不可中断低调用一个方法,内部就是在中断后继续 future.get()
     */
